...
async function seed() {
    ...
    const [namibiaCover, southAfricaCover, kenyaCover, botswanaCover, zambiaCover, tanzaniaCover, blogCover] = await Promise.all([
        uploadImage("https://images.unsplash.com/photo-1500530855697-b586d89ba3ee", "namibia.jpg"),
        uploadImage("https://images.unsplash.com/photo-1500530855697-b586d89ba3ee", "south-africa.jpg"),
        ...
        uploadImage("https://images.unsplash.com/photo-1526498460520-4c246339dccb", "tanzania.jpg"),
    ...
    const docs = [
        ...
        {
            _id: "country-tanzania",
            _type: "country",
            title: "Tanzania",
            slug: { _type: "slug", current: "tanzania" },
            featured: false,
            badge: "Safari ready",
            coverImage: tanzaniaCover,
            summary: "Reliable data from Zanzibar beaches to Serengeti game drives.",
            carriers: [],
            plans: []
        },
        {
