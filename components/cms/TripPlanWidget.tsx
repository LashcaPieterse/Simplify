...
export function TripPlanWidget({
  ...
  return (
    <div className="relative rounded-3xl border border-brand-100/80 bg-white/75 p-5 shadow-card backdrop-blur-lg sm:p-6">
          ...
          {USAGE_PROFILES.map((profile) => {
            ...
            return (
              <button
                ...
                type="button"
                className={cn(
                  "flex min-h-12 items-center gap-2 rounded-2xl border px-3 py-2 text-left text-xs font-semibold transition",
                  selected
              ...
              >
                ...
                <span className="min-w-0 leading-snug">{profile.label}</span>
              </button>
            );
          })}
        </div>
    ...
    <article className="rounded-2xl border border-brand-100 bg-white p-4 shadow-sm">
      ...
      <div className="flex gap-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-2 text-sm text-brand-700">{recommendation.fitReason}</p>
        </div>
      </div>
...
function CompactAlternative({
  ...
  if (!recommendation) {
    return (
      <div className="rounded-2xl border border-brand-100 bg-white/70 px-4 py-3 text-xs text-brand-500">
  ...
  return (
    <article className="rounded-2xl border border-brand-100 bg-white px-4 py-3 shadow-sm">
      ...
      <h4 className="line-clamp-2 min-h-9 text-sm font-semibold leading-snug text-brand-900">
...
function EmptyState() {
  return (
    <div className="rounded-2xl border border-brand-100 bg-white px-4 py-4 text-sm text-brand-600">
