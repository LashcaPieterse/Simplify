...
export function SiteHeader({ settings }: { settings: SiteSettings }) {
  ...
  return (
    <header className="relative z-20 mx-auto flex w-full max-w-[104rem] items-center justify-between gap-3 px-5 pb-7 pt-8 sm:px-6 sm:pb-8 sm:pt-10 lg:px-10 lg:pb-5 lg:pt-7 xl:px-12 xl:pb-6 xl:pt-8">
